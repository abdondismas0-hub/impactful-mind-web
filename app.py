...
app.config['SECRET_KEY'] = 'impactful-key-123'
...
# --- PUBLIC ROUTES (WAGENI) ---

@app.route("/")
def home():
    # Hii ndiyo Homepage. Haina login_required.
    try:
        ...
        # Ikitokea error ya DB, onyesha vitu vitupu badala ya crash
        carousel_posts = []
        latest_posts = []
        latest_books = []
        about_info = None
...
# ... (Routes za kuongeza vitabu/posts zinabaki kama zilivyo, hakikisha unazo kwenye faili lako) ...
